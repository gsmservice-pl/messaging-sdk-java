 ...
 * SendSmsRequestBody
 * 
 * <p>To send a single SMS or messages with the same content to multiple recipients, please use <code>SendSmsRequestBody.of(SmsMessage)</code> method with a single <code>SmsMessage</code> object with the properties of this message. To send multiple messages with different content at the same time, please use <code>SendSmsRequestBody.of(List.of(SmsMessage,...))</code> method passing to it <code>List&lt;SmsMessage&gt;</code> with the properties of each message.
 */
