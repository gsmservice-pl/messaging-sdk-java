 ...
 * 
 * <p>To check the price of a single message or messages with the same content to multiple recipients, pass a single <code>SmsMessage</code> object with the properties of this message using <code>GetSmsPriceRequestBody.of(SmsMessage)</code> method. To check the price of multiple messages with different content at the same time, pass a <code>List&lt;SmsMessage&gt;</code> with the properties of each message using <code>GetSmsPriceRequestBody.of(List.of(SmsMessage,...))</code> method.
 */
