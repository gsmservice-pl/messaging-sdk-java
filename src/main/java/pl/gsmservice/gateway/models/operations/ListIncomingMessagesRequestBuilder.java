...
public class ListIncomingMessagesRequestBuilder {
    ...
    private final SDKMethodInterfaces.MethodCallListIncomingMessages sdk;

    public ListIncomingMessagesRequestBuilder(SDKMethodInterfaces.MethodCallListIncomingMessages sdk) {
        this.sdk = sdk;
    }
