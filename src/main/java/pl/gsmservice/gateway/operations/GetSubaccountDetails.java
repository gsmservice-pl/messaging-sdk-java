...
public class GetSubaccountDetails {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSubaccountDetailsRequest, pl.gsmservice.gateway.models.operations.async.GetSubaccountDetailsResponse> {
        ...
        @Override
        public CompletableFuture<pl.gsmservice.gateway.models.operations.async.GetSubaccountDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.gsmservice.gateway.models.operations.async.GetSubaccountDetailsResponse.Builder resBuilder =
                    pl.gsmservice.gateway.models.operations.async.GetSubaccountDetailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.gsmservice.gateway.models.operations.async.GetSubaccountDetailsResponse res = resBuilder.build();
