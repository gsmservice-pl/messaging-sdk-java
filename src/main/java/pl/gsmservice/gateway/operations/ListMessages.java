...
public class ListMessages {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMessagesRequest, ListMessagesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListMessagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMessagesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMessagesRequest request) throws Exception {
        ...
        @Override
        public ListMessagesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMessagesResponse.Builder resBuilder =
            ...
            ListMessagesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<Message> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMessages(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMessagesRequest, pl.gsmservice.gateway.models.operations.async.ListMessagesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListMessagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMessagesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMessagesRequest request) {
        ...
        @Override
        public CompletableFuture<pl.gsmservice.gateway.models.operations.async.ListMessagesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.gsmservice.gateway.models.operations.async.ListMessagesResponse.Builder resBuilder =
                    pl.gsmservice.gateway.models.operations.async.ListMessagesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.gsmservice.gateway.models.operations.async.ListMessagesResponse res = resBuilder.build();
