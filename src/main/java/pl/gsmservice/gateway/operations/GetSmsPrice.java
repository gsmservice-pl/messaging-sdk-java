...
public class GetSmsPrice {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSmsPriceRequestBody, GetSmsPriceResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSmsPriceRequestBody request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<GetSmsPriceRequestBody>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSmsPriceRequestBody request) throws Exception {
        ...
        @Override
        public GetSmsPriceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSmsPriceResponse.Builder resBuilder =
                    GetSmsPriceResponse
                            .builder()
            ...
            GetSmsPriceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSmsPriceRequestBody, pl.gsmservice.gateway.models.operations.async.GetSmsPriceResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSmsPriceRequestBody request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<GetSmsPriceRequestBody>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSmsPriceRequestBody request) {
        ...
        @Override
        public CompletableFuture<pl.gsmservice.gateway.models.operations.async.GetSmsPriceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.gsmservice.gateway.models.operations.async.GetSmsPriceResponse.Builder resBuilder =
                    pl.gsmservice.gateway.models.operations.async.GetSmsPriceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.gsmservice.gateway.models.operations.async.GetSmsPriceResponse res = resBuilder.build();
