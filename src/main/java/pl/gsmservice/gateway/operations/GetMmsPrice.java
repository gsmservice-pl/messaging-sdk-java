...
public class GetMmsPrice {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMmsPriceRequestBody, GetMmsPriceResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetMmsPriceRequestBody request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<GetMmsPriceRequestBody>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMmsPriceRequestBody request) throws Exception {
        ...
        @Override
        public GetMmsPriceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMmsPriceResponse.Builder resBuilder =
                    GetMmsPriceResponse
                            .builder()
            ...
            GetMmsPriceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<Price> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPrices(out);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMmsPriceRequestBody, pl.gsmservice.gateway.models.operations.async.GetMmsPriceResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetMmsPriceRequestBody request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<GetMmsPriceRequestBody>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMmsPriceRequestBody request) {
        ...
        @Override
        public CompletableFuture<pl.gsmservice.gateway.models.operations.async.GetMmsPriceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.gsmservice.gateway.models.operations.async.GetMmsPriceResponse.Builder resBuilder =
                    pl.gsmservice.gateway.models.operations.async.GetMmsPriceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.gsmservice.gateway.models.operations.async.GetMmsPriceResponse res = resBuilder.build();
