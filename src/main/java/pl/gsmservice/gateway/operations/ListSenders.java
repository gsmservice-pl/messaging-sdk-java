...
public class ListSenders {
        ...
        public ListSendersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<Sender> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withSenders(out);
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<pl.gsmservice.gateway.models.operations.async.ListSendersResponse> {
        ...
        @Override
        public CompletableFuture<pl.gsmservice.gateway.models.operations.async.ListSendersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.gsmservice.gateway.models.operations.async.ListSendersResponse.Builder resBuilder =
                    pl.gsmservice.gateway.models.operations.async.ListSendersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.gsmservice.gateway.models.operations.async.ListSendersResponse res = resBuilder.build();
