...
public class CancelMessages {
    ...
    public static class Sync extends Base
            implements RequestOperation<CancelMessagesRequest, CancelMessagesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CancelMessagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelMessagesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CancelMessagesRequest request) throws Exception {
        ...
        @Override
        public CancelMessagesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CancelMessagesResponse.Builder resBuilder =
            ...
            CancelMessagesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<CancelledMessage> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCancelledMessages(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CancelMessagesRequest, pl.gsmservice.gateway.models.operations.async.CancelMessagesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CancelMessagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelMessagesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CancelMessagesRequest request) {
        ...
        @Override
        public CompletableFuture<pl.gsmservice.gateway.models.operations.async.CancelMessagesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.gsmservice.gateway.models.operations.async.CancelMessagesResponse.Builder resBuilder =
                    pl.gsmservice.gateway.models.operations.async.CancelMessagesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.gsmservice.gateway.models.operations.async.CancelMessagesResponse res = resBuilder.build();
