...
public class DeleteSender {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteSenderRequest, pl.gsmservice.gateway.models.operations.async.DeleteSenderResponse> {
        ...
        @Override
        public CompletableFuture<pl.gsmservice.gateway.models.operations.async.DeleteSenderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.gsmservice.gateway.models.operations.async.DeleteSenderResponse.Builder resBuilder =
                    pl.gsmservice.gateway.models.operations.async.DeleteSenderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
