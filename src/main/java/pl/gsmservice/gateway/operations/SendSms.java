...
public class SendSms {
    ...
    public static class Sync extends Base
            implements RequestOperation<SendSmsRequestBody, SendSmsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(SendSmsRequestBody request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<SendSmsRequestBody>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SendSmsRequestBody request) throws Exception {
        ...
        @Override
        public SendSmsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SendSmsResponse.Builder resBuilder =
                    SendSmsResponse
                            .builder()
            ...
            SendSmsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SendSmsRequestBody, pl.gsmservice.gateway.models.operations.async.SendSmsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SendSmsRequestBody request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<SendSmsRequestBody>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SendSmsRequestBody request) {
        ...
        @Override
        public CompletableFuture<pl.gsmservice.gateway.models.operations.async.SendSmsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.gsmservice.gateway.models.operations.async.SendSmsResponse.Builder resBuilder =
                    pl.gsmservice.gateway.models.operations.async.SendSmsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.gsmservice.gateway.models.operations.async.SendSmsResponse res = resBuilder.build();
