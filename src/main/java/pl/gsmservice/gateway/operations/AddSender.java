...
public class AddSender {
    ...
    public static class Sync extends Base
            implements RequestOperation<SenderInput, AddSenderResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(SenderInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<SenderInput>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SenderInput request) throws Exception {
        ...
        public AddSenderResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Sender out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withSender(out);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SenderInput, pl.gsmservice.gateway.models.operations.async.AddSenderResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SenderInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<SenderInput>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SenderInput request) {
        ...
        @Override
        public CompletableFuture<pl.gsmservice.gateway.models.operations.async.AddSenderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.gsmservice.gateway.models.operations.async.AddSenderResponse.Builder resBuilder =
                    pl.gsmservice.gateway.models.operations.async.AddSenderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.gsmservice.gateway.models.operations.async.AddSenderResponse res = resBuilder.build();
