...
public class SendMms {
    ...
    public static class Sync extends Base
            implements RequestOperation<SendMmsRequestBody, SendMmsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(SendMmsRequestBody request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<SendMmsRequestBody>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SendMmsRequestBody request) throws Exception {
        ...
        @Override
        public SendMmsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SendMmsResponse.Builder resBuilder =
                    SendMmsResponse
                            .builder()
            ...
            SendMmsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SendMmsRequestBody, pl.gsmservice.gateway.models.operations.async.SendMmsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SendMmsRequestBody request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<SendMmsRequestBody>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SendMmsRequestBody request) {
        ...
        @Override
        public CompletableFuture<pl.gsmservice.gateway.models.operations.async.SendMmsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.gsmservice.gateway.models.operations.async.SendMmsResponse.Builder resBuilder =
                    pl.gsmservice.gateway.models.operations.async.SendMmsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            pl.gsmservice.gateway.models.operations.async.SendMmsResponse res = resBuilder.build();
