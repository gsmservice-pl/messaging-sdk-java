...
public class Ping {
        ...
        public PingResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    pl.gsmservice.gateway.models.components.PingResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<pl.gsmservice.gateway.models.operations.async.PingResponse> {
        ...
        @Override
        public CompletableFuture<pl.gsmservice.gateway.models.operations.async.PingResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            pl.gsmservice.gateway.models.operations.async.PingResponse.Builder resBuilder =
            ...
            pl.gsmservice.gateway.models.operations.async.PingResponse res = resBuilder.build();
